...
class BuildMessagesCommand(distutils.core.Command):
    ...
    def run(self):
        ...
        # be set to e.g. 'wshop_workbench.settings' but if we're in
        # middle of installing Wshop, then management commands will fail
        # because wshop_workbench is not yet installed.
