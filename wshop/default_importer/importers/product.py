...
from wshop.importer.importing import DataImporter, ImportMetaBase
from wshop.importer.utils import fold_mapping_name
...
class ProductMetaBase(ImportMetaBase):
    ...
    def handle_stocks(self, fields, sess):
        ...
        # wshop only has 1 supplier support now so get first
