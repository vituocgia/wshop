...
from wshop.notify.typology import Boolean, Model
...
class AlertLimitReached(Event):
    ...
    supplier = Variable(_("Supplier"), type=Model("wshop.Supplier"))
    product = Variable(_("Product"), type=Model("wshop.Product"))
