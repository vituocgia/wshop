...
from wshop.core.models import Product, StockBehavior, Supplier
from wshop.simple_supplier.forms import AlertLimitForm, StockAdjustmentForm
from wshop.simple_supplier.models import StockCount
from wshop.simple_supplier.utils import (
...
class StocksListView(PicotableListView):
    template_name = "wshop/simple_supplier/admin/base_picotable.jinja"
    model = Product
    default_columns = [
        Column(
