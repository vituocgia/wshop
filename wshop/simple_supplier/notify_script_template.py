...
from wshop.notify.actions import SendEmail
from wshop.notify.conditions import BooleanEqual
from wshop.notify.script import Step, StepNext
from wshop.notify.script_template.generic import GenericSendEmailScriptTemplate
