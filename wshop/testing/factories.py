...
from wshop.core.defaults.order_statuses import create_default_order_statuses
...
from wshop.core.order_creator import OrderCreator, OrderSource
from wshop.core.pricing import get_pricing_module
from wshop.core.shortcuts import update_order_line_from_product
from wshop.core.taxing.utils import stacked_value_added_taxes
from wshop.default_tax.models import TaxRule
from wshop.testing.text_data import random_title
from wshop.utils.filer import filer_image_from_data
...
class UserFactory(DjangoModelFactory):
    ...
    email = factory.Sequence(lambda n: 'user{0}@example.wshop.com'.format(n))
...
class CompanyFactory(DjangoModelFactory):
    ...
    email = factory.Sequence(lambda n: 'company%d@example.wshop.com' % n)
...
def get_shop(prices_include_tax=True, currency=DEFAULT_CURRENCY, identifier=None, enabled=False, **kwargs):
    ...
    # make sure that the currency is available throughout the Wshop
