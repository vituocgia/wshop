...
from wshop.addons.installer import PackageInstaller
from wshop.admin.toolbar import PostActionButton, Toolbar
from wshop.admin.utils.urls import manipulate_query_string
from wshop.utils.excs import Problem
from wshop.utils.iterables import first
...
class AddonUploadView(FormView):
    ...
    template_name = "wshop/admin/addons/upload.jinja"
    title = "Upload Addon"
    ...
    def form_valid(self, form):
        ...
        tmp_dir = tempfile.mkdtemp(prefix='wshop')
        ...
        return HttpResponseRedirect(
            manipulate_query_string(
                reverse("wshop_admin:addon.upload_confirm"),
                file=filename,
                token=tmp_token
            )
        )
...
class AddonUploadConfirmView(FormView):
    ...
    template_name = "wshop/admin/addons/upload_confirm.jinja"
    title = "Upload Addon"
    ...
    def form_valid(self, form):
        ...
        self.template_name = "wshop/admin/addons/upload_complete.jinja"
        context = {}
        try:
            ...
            if hasattr(settings, 'WHEEL_USER'):
                ...
                from wshop.addons.verify import verify_wheel
