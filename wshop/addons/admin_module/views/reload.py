...
from wshop.addons.manager import get_enabled_addons
from wshop.addons.reloader import get_reload_method_classes
from wshop.apps.settings import reload_apps
...
class ReloadView(FormView):
    template_name = "wshop/admin/addons/reload.jinja"
