...
from wshop.core.models import OrderLine
from wshop.core.pricing import TaxfulPrice, TaxlessPrice
from wshop.default_reports.forms import ProductTotalSalesReportForm
from wshop.default_reports.mixins import OrderReportMixin
from wshop.reports.report import WshopReportBase


class ProductSalesReport(OrderReportMixin, WshopReportBase):
