...
from wshop.core.models import OrderLineTax, Tax
from wshop.default_reports.forms import TaxesReportForm
...
class TaxesReport(OrderReportMixin, WshopReportBase):
