...
from wshop.core.models import Category, ProductCrossSell, ProductCrossSellType
from wshop.front.template_helpers.general import (
    get_best_selling_products, get_newest_products, get_products_for_category,
    get_random_products
)
from wshop.front.template_helpers.product import map_relation_type
from wshop.xtheme import TemplatedPlugin
from wshop.xtheme.plugins.forms import GenericPluginForm, TranslatableField
from wshop.xtheme.plugins.widgets import XThemeModelChoiceField


class ProductHighlightPlugin(TemplatedPlugin):
    identifier = "product_highlight"
    name = _("Product Highlights")
    template_name = "wshop/xtheme/plugins/highlight_plugin.jinja"
    fields = [
...
class ProductCrossSellsPlugin(TemplatedPlugin):
    ...
    template_name = "wshop/xtheme/plugins/cross_sells_plugin.jinja"
