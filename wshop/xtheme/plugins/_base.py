...
from wshop.apps.provides import (
    get_identifier_to_object_map, get_provide_objects
)
from wshop.utils.importing import load
from wshop.utils.text import space_case
from wshop.xtheme.plugins.consts import FALLBACK_LANGUAGE_CODE
from wshop.xtheme.plugins.forms import GenericPluginForm
...
class Plugin(object):
    """
    A plugin that can be instantiated within a `wshop.xtheme.layout.LayoutCell`.
    ...
    def get_translated_value(self, key, default=None, language=None):
        ...
        This is the protocol that `wshop.xtheme.plugins.forms.TranslatableField` uses.
