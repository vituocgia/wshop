...
from wshop.xtheme.extenders import MenuExtenderLocation
...
class Theme(object):
    ...
    # If `None`, the default `wshop.front` templates is used instead.
    ...
    def settings_obj(self):
        ...
        :rtype: wshop.xtheme.models.ThemeSettings
        """
    ...
    def has_images(self):
        ...
        if isinstance(self.stylesheets[0], dict):
            ...
            warnings.warn(
                ...
                "in Wshop 0.5.7. Use list of dictionaries instead.", RemovedInFutureWshopWarning)
        return False
...
def override_current_theme_class(theme_class=_not_set, shop=None):
    ...
    from wshop.xtheme.views.extra import clear_view_cache
