...
from wshop.xtheme._theme import (
    ...
    def get_form_defs(self):
        ...
        return [
            TemplatedWizardFormDef(
                template_name="wshop/xtheme/admin/wizard.jinja",
                name="theme",
...
class ThemeConfigView(FormView):
    ...
    """
    template_name = "wshop/xtheme/admin/config.jinja"
    form_class = ActivationForm
...
class ThemeConfigDetailView(CreateOrUpdateView):
    ...
    """
    model = ThemeSettings
    template_name = "wshop/xtheme/admin/config_detail.jinja"
    ...
    def get_success_url(self):
        return reverse("wshop_admin:xtheme.config_detail", kwargs={
