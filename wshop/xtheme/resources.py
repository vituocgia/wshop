...
from wshop.core.fields import TaggedJSONEncoder
...
class ResourceContainer(object):
    ...
    `~wshop.xtheme.engine.XthemeTemplate` (akin to how `django-jinja`'s Template injects
...
def get_resource_container(context):
    ...
    :rtype: wshop.xtheme.resources.ResourceContainer|None
    """
