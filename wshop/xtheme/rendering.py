...
from wshop.core.fields.tagged_json import TaggedJSONEncoder
from wshop.xtheme._theme import get_current_theme
from wshop.xtheme.editing import is_edit_mode
from wshop.xtheme.utils import get_html_attrs
from wshop.xtheme.view_config import ViewConfig
...
def get_view_config(context, global_type=False):
    ...
    :return: View config
    :rtype: wshop.xtheme.view_config.ViewConfig
    """
...
class PlaceholderRenderer(object):
    ...
    def _render_row(self, write, y, row):
        ...
        :type row: wshop.xtheme.view_config.LayoutRow
        """
        row_attrs = {
    ...
    def _render_cell(self, write, x, cell):
        ...
        :type x: int
        :param cell: Cell
        :type cell: wshop.xtheme.view_config.LayoutCell
        """
        classes = ["xt-ph-cell"]
