...
from wshop.core.fields import TaggedJSONField
...
class SavedViewConfig(models.Model):
    ...
    shop = models.ForeignKey("wshop.Shop", related_name="saved_views_config", null=True)
...
class ThemeSettings(models.Model):
    theme_identifier = models.CharField(max_length=64, db_index=True, verbose_name=_("theme identifier"))
    shop = models.ForeignKey("wshop.Shop", related_name="themes_settings", null=True)
