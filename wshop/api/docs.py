...
class WshopAPISchemaGenerator(SchemaGenerator):
    ...
    def get_serializer_fields(self, path, method, view):
        ...
        The attribute will be available when decorated with `wshop.api.decorators.schema_serializer_class`.
        """
...
class SwaggerSchemaView(APIView):
    ...
    def get(self, request):
        generator = WshopAPISchemaGenerator(title="Wshop API")
