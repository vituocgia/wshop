...
from wshop.core.fields import MoneyValueField
from wshop.core.utils.context_cache import bump_cache_for_product
from wshop.utils.properties import MoneyPropped, PriceProperty
...
class CgpBase(models.Model):
    ...
    shop = models.ForeignKey("wshop.Shop", db_index=True, on_delete=models.CASCADE, verbose_name=_("shop"))
    group = models.ForeignKey(
        "wshop.ContactGroup", db_index=True, on_delete=models.CASCADE, verbose_name=_("contact group"))
