...
from wshop.core.models import ProductVariationResult, ShopProduct
from wshop.front.views.product import ProductDetailView
from wshop.utils.numbers import parse_simple_decimal


class ProductPriceView(ProductDetailView):
    template_name = "wshop/front/product/detail_order_section.jinja"
    ...
    def get_context_data(self, **kwargs):
        ...
        if not context["product"] or not self.is_orderable():
            self.template_name = "wshop/front/product/detail_order_section_no_product.jinja"
            return context
        quantity = self._get_quantity()
