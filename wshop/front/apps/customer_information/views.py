...
from wshop.front.views.dashboard import DashboardViewMixin
...
class PasswordChangeView(DashboardViewMixin, TemplateView):
    template_name = "wshop/customer_information/change_password.jinja"

    def post(self, *args, **kwargs):
        response = password_change(
            self.request,
            post_change_redirect="wshop:customer_edit",
...
class CustomerEditView(DashboardViewMixin, FormView):
    template_name = "wshop/customer_information/edit_customer.jinja"
...
class CompanyEditView(DashboardViewMixin, FormView):
    template_name = "wshop/customer_information/edit_company.jinja"
...
class AddressBookView(DashboardViewMixin, TemplateView):
    template_name = "wshop/customer_information/addressbook/index.jinja"
...
class AddressBookEditView(DashboardViewMixin, FormView):
    template_name = "wshop/customer_information/addressbook/edit.jinja"
    ...
    def get_form(self, form_class):
        ...
        form_group.add_form_def("address", cached_load("WSHOP_ADDRESS_MODEL_FORM"), kwargs=address_kwargs)
        form_group.add_form_def(
            "saved_address",
            SavedAddressForm,
    ...
    def form_valid(self, form):
        ...
        return redirect("wshop:address_book_edit", pk=saved_address.pk)
...
def delete_address(request, pk):
    ...
    return redirect("wshop:address_book")
