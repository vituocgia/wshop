...
from wshop.xtheme.resources import add_resource
...
class RecentlyViewedProductsPlugin(TemplatedPlugin):
    ...
    template_name = "wshop/recently_viewed_products/list_view.jinja"
...
def add_resources(context, content):
    ...
    if view_name == "ProductDetailView":
        add_resource(context, "body_end", "%swshop/recently_viewed_products/lib.js" % settings.STATIC_URL)
