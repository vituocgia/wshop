...
from wshop.core.models._base import WshopModel, TranslatableWshopModel
...
class Carousel(WshopModel):
    shops = models.ManyToManyField("wshop.Shop", related_name="carousels", verbose_name=_('shops'), help_text=_(
