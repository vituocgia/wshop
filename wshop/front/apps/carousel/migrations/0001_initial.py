...
import wshop.front.apps.carousel.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('animation', enumfields.fields.EnumIntegerField(help_text='Animation type for cycling slides.', enum=wshop.front.apps.carousel.models.CarouselMode, verbose_name='animation', default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target', enumfields.fields.EnumIntegerField(verbose_name='link target', enum=wshop.front.apps.carousel.models.LinkTargetType, default=0)),
                ...
                ('category_link', models.ForeignKey(to='wshop.Category', related_name='+', null=True, verbose_name='category link', blank=True)),
                ('cms_page_link', models.ForeignKey(to='wshop_simple_cms.Page', related_name='+', null=True, verbose_name='cms page link', blank=True)),
                ('product_link', models.ForeignKey(to='wshop.Product', related_name='+', null=True, verbose_name='product link', blank=True)),
            ],
            options={
