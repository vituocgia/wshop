...
from wshop.front.apps.carousel.admin_module.forms import (
...
class CarouselEditView(FormPartsViewMixin, SaveFormPartsMixin, CreateOrUpdateView):
    model = Carousel
    template_name = "wshop/carousel/admin/edit.jinja"
    ...
    def get_toolbar(self):
        ...
        if save_form_id:
            return get_default_edit_toolbar(self, save_form_id, delete_url="wshop_admin:carousel.delete")
