...
from wshop.core.models import Order, ProductMode, Supplier
...
class OrderListView(DashboardViewMixin, OrderViewMixin, django.views.generic.ListView):
    template_name = 'wshop/personal_order_history/order_list.jinja'
    context_object_name = 'orders'


class OrderDetailView(DashboardViewMixin, OrderViewMixin, django.views.generic.DetailView):
    template_name = 'wshop/personal_order_history/order_detail.jinja'
...
class ReorderView(View):
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            return HttpResponseRedirect(reverse("wshop:show-order", kwargs=kwargs))
        ...
        return HttpResponseRedirect(reverse("wshop:basket"))
