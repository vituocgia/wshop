...
from wshop.core.models import PaymentStatus, ShipmentStatus, ShippingStatus
...
from wshop.notify.typology import Email, Enum, Language, Model, Phone
...
class OrderReceived(Event):
    ...
    order = Variable(_("Order"), type=Model("wshop.Order"))
...
class ShipmentCreated(Event):
    ...
    shipment = Variable(_("Shipment"), type=Model("wshop.Shipment"))
...
class PaymentCreated(Event):
    ...
    payment = Variable(_("Payment"), type=Model("wshop.Payment"))
