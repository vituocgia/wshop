...
class MethodWidget(forms.Widget):
    ...
    def render(self, name, value, attrs=None):
        return mark_safe(
            render_to_string("wshop/front/checkout/method_choice.jinja", {
...
class MethodsForm(forms.Form):
    ...
    def limit_method_fields(self):
        basket = self.basket  # type: wshop.front.basket.objects.BaseBasket
...
class MethodsPhase(CheckoutPhaseViewMixin, FormView):
    ...
    template_name = "wshop/front/checkout/methods.jinja"
