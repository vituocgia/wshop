...
from wshop.front.apps.auth.views import LoginView
from wshop.front.apps.registration.views import RegistrationNoActivationView
...
class CheckoutMethodPhase(CheckoutPhaseViewMixin, LoginView):
    ...
    template_name = "wshop/front/checkout/checkout_method.jinja"
...
class RegisterPhase(CheckoutPhaseViewMixin, RegistrationNoActivationView):
    identifier = "register"
    title = _("Register")
    template_name = "wshop/front/checkout/register.jinja"
