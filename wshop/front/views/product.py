...
from wshop.core.models import Product, ProductMode, ShopProduct
from wshop.front.utils.product import get_product_context
from wshop.utils.excs import extract_messages, Problem


class ProductDetailView(DetailView):
    template_name = "wshop/front/product/detail.jinja"
    model = Product
    ...
    def get(self, request, *args, **kwargs):
        ...
        if product.mode == ProductMode.VARIATION_CHILD:
            return redirect("wshop:product", pk=product.variation_parent.pk, slug=product.variation_parent.slug)
