...
from wshop.core.models import Order, PaymentUrls
...
def get_payment_urls(request, order):
    ...
    return PaymentUrls(
        payment_url=absolute_url_for("wshop:order_process_payment"),
        return_url=absolute_url_for("wshop:order_process_payment_return"),
        cancel_url=absolute_url_for("wshop:order_payment_canceled"),
    )
...
class ProcessPaymentView(DetailView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if mode == "payment":
            ...
            self.template_name = "wshop/front/order/payment_canceled.jinja"
        ...
        return redirect("wshop:order_complete", pk=order.pk, key=order.key)
