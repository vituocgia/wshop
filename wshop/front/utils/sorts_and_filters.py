...
from wshop.xtheme import get_theme_cache_key
...
class ProductListFormModifier(six.with_metaclass(abc.ABCMeta)):
    ...
    def get_fields(self, request, category=None):
        ...
        :type category: wshop.core.models.Category|None
    ...
    def sort_products(self, request, products, data):
        ...
        :type products: list[wshop.code.models.Product]
        :param data: product list form data
        :type data: dict
        :return: List of products that might be sorted
        :rtype: list[wshop.code.models.Product]
        """
        return products
    ...
    def filter_products(self, request, products, data):
        ...
        :rtype products: list[wshop.core.models.Product]
        :param data: Data from ProductListForm
        :type data: dict
        :return: Filtered product list
        :rtype: list[wshop.core.models.Product]
        """
        return products
...
def get_configuration(shop=None, category=None):
    default_configuration = configuration.get(
        shop, FACETED_DEFAULT_CONF_KEY, settings.WSHOP_FRONT_DEFAULT_SORT_CONFIGURATION)
