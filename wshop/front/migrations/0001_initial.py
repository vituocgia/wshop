    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(verbose_name='key', max_length=32, default=wshop.front.models.stored_basket.generate_key)),
                ...
                ('data', wshop.core.fields.TaggedJSONField(verbose_name='data')),
                ('taxless_total_price_value', wshop.core.fields.MoneyValueField(blank=True, null=True, verbose_name='taxless total price', decimal_places=9, default=0, max_digits=36)),
                ('taxful_total_price_value', wshop.core.fields.MoneyValueField(blank=True, null=True, verbose_name='taxful total price', decimal_places=9, default=0, max_digits=36)),
                ...
                ('customer', models.ForeignKey(blank=True, related_name='customer_baskets', to='wshop.Contact', null=True, verbose_name='customer')),
                ('orderer', models.ForeignKey(blank=True, related_name='orderer_baskets', to='wshop.PersonContact', null=True, verbose_name='orderer')),
