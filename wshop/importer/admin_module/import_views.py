...
from wshop.core.models import Shop, Supplier
from wshop.importer.admin_module.forms import ImportForm, ImportSettingsForm
from wshop.importer.transforms import transform_file
from wshop.importer.utils import get_import_file_path, get_importer
from wshop.utils.excs import Problem


class ImportProcessView(TemplateView):
    template_name = "wshop/importer/admin/import_process.jinja"
    importer = None
    ...
    def post(self, request, *args, **kwargs):
        ...
        if not prepared:
            return redirect(reverse("wshop_admin:importer.import"))
        self.importer.do_import(self.settings_form.cleaned_data["import_mode"])
        self.template_name = "wshop/importer/admin/import_process_complete.jinja"
...
class ImportView(FormView):
    template_name = "wshop/importer/admin/import.jinja"
