...
from wshop.importer.utils import get_global_aliases
...
class ImportMetaBase(object):
    ...
    def presave_hook(self, row_session):
        ...
        :type row_session: wshop.importer.importing.session.DataImporterRowSession
        :return: None
        """
        pass
