...
import wshop.campaigns.models.basket_conditions
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operator', enumfields.fields.EnumIntegerField(verbose_name='operator', enum=wshop.campaigns.models.basket_conditions.ComparisonOperator, default=1)),
                ('quantity', models.PositiveIntegerField(verbose_name='quantity', default=1)),
                ('category', models.ForeignKey(blank=True, null=True, to='wshop.Category', verbose_name='category')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_amount', wshop.core.fields.MoneyValueField(null=True, decimal_places=9, blank=True, help_text='Flat amount of discount.', default=None, max_digits=36, verbose_name='discount amount')),
                ...
                ('category', models.ForeignKey(verbose_name='category', to='wshop.Category')),
            ],
            options={
                'abstract': False,
            },
