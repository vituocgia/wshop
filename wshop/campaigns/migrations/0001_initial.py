    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', wshop.core.fields.InternalIdentifierField(max_length=64, null=True, unique=True, editable=False, blank=True)),
            ...
            bases=(wshop.utils.properties.MoneyPropped, parler.models.TranslatableModelMixin, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, verbose_name='ID', auto_created=True, primary_key=True)),
                ('min_value', wshop.core.fields.MoneyValueField(blank=True, decimal_places=9, verbose_name='min amount', null=True, max_digits=36)),
                ('max_value', wshop.core.fields.MoneyValueField(blank=True, decimal_places=9, verbose_name='max amount', null=True, max_digits=36)),
                ('group', models.ForeignKey(related_name='+', to='wshop.ContactGroup', verbose_name='group')),
                ('shop', models.ForeignKey(related_name='+', to='wshop.Shop', verbose_name='shop')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, null=True, verbose_name='created by')),
                ('modified_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, null=True, verbose_name='modified by')),
                ('order', models.ForeignKey(related_name='coupon_usages', to='wshop.Order')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_amount', wshop.core.fields.MoneyValueField(blank=True, null=True, verbose_name='discount amount', help_text='Flat amount of discount.', decimal_places=9, default=None, max_digits=36)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_value', wshop.core.fields.MoneyValueField(blank=True, null=True, verbose_name='maximum basket total amount', decimal_places=9, default=None, max_digits=36)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketcondition_ptr', models.OneToOneField(to='campaigns.BasketCondition', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
                ('amount_value', wshop.core.fields.MoneyValueField(blank=True, null=True, verbose_name='basket total amount', decimal_places=9, default=None, max_digits=36)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(verbose_name='categories', to='wshop.Category')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketcondition_ptr', models.OneToOneField(to='campaigns.BasketCondition', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
                ('contacts', models.ManyToManyField(verbose_name='contacts', to='wshop.Contact')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketcondition_ptr', models.OneToOneField(to='campaigns.BasketCondition', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
                ('contact_groups', models.ManyToManyField(verbose_name='contact groups', to='wshop.ContactGroup')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_amount', wshop.core.fields.MoneyValueField(blank=True, null=True, verbose_name='discount amount', help_text='Flat amount of discount.', decimal_places=9, default=None, max_digits=36)),
                ('products', models.ManyToManyField(verbose_name='product', to='wshop.Product')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketcondition_ptr', models.OneToOneField(to='campaigns.BasketCondition', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
                ('quantity', models.PositiveIntegerField(default=1, verbose_name='quantity')),
                ('products', models.ManyToManyField(blank=True, verbose_name='products', to='wshop.Product')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('catalogfilter_ptr', models.OneToOneField(to='campaigns.CatalogFilter', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
                ('product_types', models.ManyToManyField(verbose_name='product Types', to='wshop.ProductType')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='catalogcampaign',
            name='shop',
            field=models.ForeignKey(to='wshop.Shop', verbose_name='shop', help_text='The shop where campaign is active.'),
        ),
        migrations.AddField(
