...
class CatalogCampaignListView(CampaignListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["toolbar"] = Toolbar([
            NewActionButton("wshop_admin:catalog_campaign.new", text=_("Create new Catalog Campaign")),
            settings_button
        ])
        return context
...
class BasketCampaignListView(CampaignListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.user.is_superuser:
            ...
            settings_button = None
        context["toolbar"] = Toolbar([
            NewActionButton("wshop_admin:basket_campaign.new", text=_("Create new Basket Campaign")),
            settings_button
        ])
        return context
...
class CouponListView(PicotableListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.user.is_superuser:
            ...
            settings_button = None
        context["toolbar"] = Toolbar([
            NewActionButton("wshop_admin:coupon.new", text=_("Create new Coupon")),
            settings_button
        ])
        return context
