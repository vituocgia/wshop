...
from wshop.campaigns.admin_module.form_parts import (
...
from wshop.campaigns.admin_module.forms import CouponForm
...
class CampaignEditView(SaveFormPartsMixin, FormPartsViewMixin, CreateOrUpdateView):
    template_name = "wshop/campaigns/admin/edit_campaigns.jinja"
...
class CatalogCampaignEditView(BreadcrumbedView, CampaignEditView):
    ...
    parent_url = "wshop_admin:catalog_campaign.list"
...
class BasketCampaignEditView(BreadcrumbedView, CampaignEditView):
    ...
    parent_url = "wshop_admin:basket_campaign.list"


class CouponEditView(BreadcrumbedView, CreateOrUpdateView):
    model = Coupon
    template_name = "wshop/campaigns/admin/edit_coupons.jinja"
    form_class = CouponForm
    context_object_name = "coupon"
    add_form_errors_as_messages = True
    parent_name = _("Coupon")
    parent_url = "wshop_admin:coupon.list"
