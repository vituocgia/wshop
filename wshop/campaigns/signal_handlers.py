...
from wshop.campaigns.models import CatalogFilter
from wshop.campaigns.models.contact_group_sales_ranges import \
    ContactGroupSalesRange
from wshop.campaigns.models.matching import (
    update_matching_catalog_filters, update_matching_category_filters
)
from wshop.core import cache
from wshop.core.models import Category, ShopProduct
