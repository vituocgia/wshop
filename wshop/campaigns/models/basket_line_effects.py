...
from wshop.core.models import (
    Category, OrderLineType, PolymorphicWshopModel, Product, ShopProduct
)
from wshop.core.order_creator._source import LineSource


class BasketLineEffect(PolymorphicWshopModel):
    identifier = None
    model = None
...
def _limit_discount_amount_by_min_price(line, order_source):
    ...
    :param wshop.core.order_creator.SourceLine line: the line to limit the discount
    :param wshop.core.order_source.OrderSource order_source: the order source
    """
