...
from wshop.core.models import PolymorphicWshopModel


class ProductDiscountEffect(PolymorphicWshopModel):
    identifier = None
    model = None
    ...
    def apply_for_product(self, context, product, price_info):
        ...
        :type context: wshop.core.pricing._context.PricingContextable
