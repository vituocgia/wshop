...
from wshop.admin.utils.forms import flatatt_filter
...
class QuickAddCategoryMultiSelect(QuickAddRelatedObjectMultiSelect):
    url = reverse_lazy("wshop_admin:category.new")
