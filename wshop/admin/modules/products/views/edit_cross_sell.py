...
from wshop.admin.forms.widgets import ProductChoiceWidget
from wshop.admin.toolbar import PostActionButton, Toolbar
from wshop.admin.utils.urls import get_model_url
from wshop.core.models import Product, ProductCrossSell, ProductCrossSellType
...
class ProductCrossSellEditView(UpdateView):
    model = Product
    template_name = "wshop/admin/products/edit_cross_sell.jinja"
