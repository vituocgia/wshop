...
from wshop.core.models import ProductMode, Shop, ShopProduct
...
class ProductListView(PicotableListView):
    ...
    related_objects = [
        ("product", "wshop.core.models:Product"),
    ]

    mass_actions = [
        "wshop.admin.modules.products.mass_actions:VisibleMassAction",
        "wshop.admin.modules.products.mass_actions:InvisibleMassAction",
    ...
    def get_primary_image(self, instance):
        ...
        return "<img src='%s'>" % static("wshop_admin/img/no_image_thumbnail.png")
