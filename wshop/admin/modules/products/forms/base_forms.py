...
from wshop.admin.signals import form_post_clean, form_pre_clean
...
from wshop.utils.multilanguage_model_form import (
...
class ShopProductForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if not getattr(settings, "WSHOP_AUTO_SHOP_PRODUCT_CATEGORIES", False):
            return data
