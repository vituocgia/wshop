...
from wshop.admin.modules.products.views.list import ProductListView
...
from wshop.core.models import ShopProduct, ShopProductVisibility
...
class EditProductAttributesAction(PicotableRedirectMassAction):
    ...
    redirect_url = reverse("wshop_admin:shop_product.mass_edit")
