...
from wshop.admin.toolbar import get_default_edit_toolbar, URLActionButton
...
from wshop.core.utils.forms import FormInfoMap


class ServiceProviderEditView(CreateOrUpdateView):
    model = ServiceProvider
    template_name = "wshop/admin/service_providers/edit.jinja"
    ...
    def get_success_url(self):
        return reverse("wshop_admin:service_provider.edit", kwargs={"pk": self.object.pk})

    def get_toolbar(self):
        save_form_id = self.get_save_form_id()
        object = self.get_object()
        delete_url = reverse_lazy("wshop_admin:service_provider.delete", kwargs={"pk": object.pk})
