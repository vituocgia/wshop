...
from wshop.admin.modules.contacts.forms import (
...
from wshop.utils.form_group import FormDef
...
class ContactAddressesFormPart(FormPart):
    ...
    def get_form_defs(self):
        ...
        yield TemplatedFormDef(
            ...
            required=False, template_name="wshop/admin/contacts/_edit_addresses_form.jinja"
        )
