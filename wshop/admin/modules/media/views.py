...
from wshop.admin.modules.media.utils import delete_folder
from wshop.admin.shop_provider import get_shop
from wshop.core.models import MediaFile, MediaFolder
...
class MediaBrowserView(TemplateView):
    ...
    """
    template_name = "wshop/admin/media/browser.jinja"
