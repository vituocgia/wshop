...
from wshop.admin.forms.widgets import QuickAddUserMultiSelect
from wshop.core.models import Currency, MutableAddress, Shop
from wshop.core.settings_provider import WshopSettings
from wshop.core.utils.form_mixins import ProtectedFieldsMixin
...
class ShopBaseForm(ProtectedFieldsMixin, WshopAdminForm):
    ...
    def __init__(self, **kwargs):
        ...
        self.fields["domain"].required = WshopSettings.get_setting("WSHOP_ENABLE_MULTIPLE_SHOPS")
...
class ShopWizardForm(WshopAdminForm):
    class Meta:
        model = Shop
