...
from wshop.admin.modules.shops.forms import (
    ShopAddressWizardForm, ShopWizardForm
)
from wshop.admin.views.wizard import (
    ...
    def get_form_defs(self):
        return [
            TemplatedWizardFormDef(
                name="shop",
                template_name="wshop/admin/shops/_wizard_base_shop_form.jinja",
                extra_js="wshop/admin/shops/_wizard_base_shop_script.jinja",
