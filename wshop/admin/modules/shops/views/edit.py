...
from wshop.admin.form_part import (
    FormPart, FormPartsViewMixin, SaveFormPartsMixin, TemplatedFormDef
)
from wshop.admin.modules.shops.forms import ContactAddressForm, ShopBaseForm
...
from wshop.admin.utils.wizard import onboarding_complete
...
class ShopBaseFormPart(FormPart):
    ...
    def get_form_defs(self):
        yield TemplatedFormDef(
            "base",
            ShopBaseForm,
            template_name="wshop/admin/shops/_edit_base_shop_form.jinja",
            required=True,
            kwargs={
...
class ShopEditView(SaveFormPartsMixin, FormPartsViewMixin, CreateOrUpdateView):
    model = Shop
    template_name = "wshop/admin/shops/edit.jinja"
    ...
    def get_object(self, queryset=None):
        ...
        check_and_raise_if_only_one_allowed("WSHOP_ENABLE_MULTIPLE_SHOPS", obj)
        return obj
