...
from wshop.admin.modules.orders.toolbar import OrderDetailToolbar
from wshop.admin.utils.urls import get_model_url
from wshop.apps.provides import get_provide_objects
from wshop.core.models import Order, OrderStatus, OrderStatusRole
from wshop.utils.excs import Problem


class OrderDetailView(DetailView):
    model = Order
    template_name = "wshop/admin/orders/detail.jinja"
