...
from wshop.core.excs import NoPaymentToCreateException
from wshop.core.models import Order, PaymentStatus
from wshop.utils.money import Money


class OrderCreatePaymentView(UpdateView):
    model = Order
    template_name = "wshop/admin/orders/create_payment.jinja"
