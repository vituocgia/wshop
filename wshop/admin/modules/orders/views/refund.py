...
from wshop.admin.toolbar import PostActionButton, Toolbar, URLActionButton
...
from wshop.core.models import Order, OrderLineType
...
class OrderCreateRefundView(UpdateView):
    model = Order
    template_name = "wshop/admin/orders/create_refund.jinja"
...
class OrderCreateFullRefundView(UpdateView):
    model = Order
    template_name = "wshop/admin/orders/create_full_refund.jinja"
    context_object_name = "order"
