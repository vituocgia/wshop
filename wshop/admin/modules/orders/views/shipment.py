...
from wshop.admin.utils.forms import add_form_errors_as_messages
...
from wshop.core.models import Order, Product, Shipment, Supplier
...
class OrderCreateShipmentView(ModifiableViewMixin, UpdateView):
    model = Order
    template_name = "wshop/admin/orders/create_shipment.jinja"
    ...
    def create_shipment(self, order, product_quantities, shipment):
        ...
        :type shipment: wshop.core.models.Shipment
