...
from wshop.admin.utils.views import CreateOrUpdateView, PicotableListView
from wshop.core.models import OrderStatus, OrderStatusManager, OrderStatusRole
...
class OrderStatusEditView(BreadcrumbedView, CreateOrUpdateView):
    ...
    template_name = "wshop/admin/orders/status.jinja"
    context_object_name = "status"
    parent_name = _("Order Statuses")
    parent_url = "wshop_admin:order_status.list"
