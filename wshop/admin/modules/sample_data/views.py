...
from wshop.admin.modules.sample_data.data import BUSINESS_SEGMENTS
from wshop.admin.modules.sample_data.factories import (
    create_sample_carousel, create_sample_category, create_sample_product
)
from wshop.admin.modules.sample_data.forms import (
    ConsolidateObjectsForm, SampleObjectsWizardForm
)
from wshop.admin.views.wizard import TemplatedWizardFormDef, WizardPane
from wshop.core.models import Category, Product, Shop
...
class ConsolidateSampleObjectsView(FormView):
    ...
    template_name = "wshop/admin/sample_data/consolidate_samples.jinja"
    ...
    def form_valid(self, form):
        ...
        # uninstall carousel
        if 'wshop.front.apps.carousel' in settings.INSTALLED_APPS and \
        ...
        return HttpResponseRedirect(reverse("wshop_admin:dashboard"))
...
class SampleObjectsWizardPane(WizardPane):
    ...
    def get_form_defs(self):
        return [
            TemplatedWizardFormDef(
                ...
                template_name="wshop/admin/sample_data/wizard.jinja",
                kwargs={
                    "shop": self.object
                }
            )
    ...
    def _create_sample_carousel(cls, shop, business_segment):
        ...
        if 'wshop.xtheme' in settings.INSTALLED_APPS:
            from wshop.front.apps.carousel.plugins import CarouselPlugin
            from wshop.xtheme.plugins.products import ProductHighlightPlugin
