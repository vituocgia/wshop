...
class UserModule(AdminModule):
    name = _("Users")
    breadcrumbs_menu_entry = MenuEntry(name, url="wshop_admin:user.list")
    ...
    def get_help_blocks(self, request, kind):
        yield SimpleHelpBlock(
            ...
            icon_url="wshop_admin/img/users.png",
    ...
    def get_model_url(self, object, kind, shop=None):
        return derive_model_url(get_user_model(), "wshop_admin:user", object, kind)
