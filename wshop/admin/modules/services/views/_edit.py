...
from wshop.admin.modules.services.base_form_part import (
    PaymentMethodBaseFormPart, ShippingMethodBaseFormPart
)
from wshop.admin.modules.services.behavior_form_part import \
...
class ServiceEditView(SaveFormPartsMixin, FormPartsViewMixin, CreateOrUpdateView):
    ...
    template_name = "wshop/admin/services/edit.jinja"
