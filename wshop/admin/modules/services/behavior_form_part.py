...
from wshop.core.models import ServiceBehaviorComponent
from wshop.utils.multilanguage_model_form import TranslatableModelForm
...
class BehaviorComponentFormPart(FormPart):
    ...
    template_name = "wshop/admin/services/_edit_behavior_components_form.jinja"
