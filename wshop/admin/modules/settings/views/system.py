...
from wshop.admin.form_part import FormPartsViewMixin
from wshop.admin.modules.settings.forms.system import (
...
class SystemSettingsView(FormPartsViewMixin, FormView):
    form_class = None
    template_name = "wshop/admin/settings/edit.jinja"
    ...
    def save_form_parts(self, form):
        ...
        return redirect("wshop_admin:settings.list")
