...
from wshop.admin.modules.settings.forms import ColumnSettingsForm
from wshop.admin.modules.settings.view_settings import ViewSettings
...
class ListSettingsView(FormView):
    ...
    template_name = "wshop/admin/edit_settings.jinja"

    def dispatch(self, request, *args, **kwargs):
        module_str = "%s:%s" % (request.GET.get("module"), request.GET.get("model"))
        self.return_url = reverse("wshop_admin:%s.list" % request.GET.get("return_url"))
