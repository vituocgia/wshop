...
from wshop.admin.utils.urls import get_model_url, NoModelUrl
from wshop.apps.provides import get_provide_objects
from wshop.core.models import ProductMedia
from wshop.utils.dates import try_parse_date
from wshop.utils.i18n import format_money, get_locally_formatted_datetime
from wshop.utils.importing import load
from wshop.utils.money import Money
from wshop.utils.objects import compact
from wshop.utils.serialization import ExtendedJSONEncoder
...
class PicotableViewMixin(object):
    ...
    related_objects = []
    template_name = "wshop/admin/base_picotable.jinja"
...
class PicotableMassAction(object):
    ...
    Examples:
    * `wshop.admin.modules.orders.mass_actions.CancelOrderAction`
    * `wshop.admin.modules.products.mass_actions.VisibleMassAction`
    """
    label = _("Mass Action")
...
class PicotableFileMassAction(PicotableMassAction):
    ...
    Examples:
    * `wshop.admin.modules.orders.mass_actions.OrderConfirmationPdfAction`
    * `wshop.admin.modules.products.mass_actions.FileResponseAction`
    """
    def process(self, request, ids):
        """
...
class PicotableRedirectMassAction(PicotableMassAction):
    ...
    * `wshop.admin.modules.products.mass_actions.EditProductAttributesAction`
    """
    redirect_url = None
