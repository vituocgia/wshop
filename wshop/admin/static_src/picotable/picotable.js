...
const Picotable = (function(m, storage) {
    ...
    function getMobileFilterModal(ctrl) {
        ...
        return m("div.mobile-filters.wshop-modal-bg", {key: "mobileFilterModal"}, [
            m("div.wshop-modal-container", [
                m("div.wshop-modal-header", [
    ...
    function PicotableController() {
        ...
        ctrl.doMassAction = function(value) {
            ...
            var xhrConfig = function(xhr) {
                xhr.setRequestHeader("X-CSRFToken", window.WshopAdminConfig.csrf);
