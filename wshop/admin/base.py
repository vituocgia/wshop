...
class AdminModule(object):
    ...
    def get_menu_entries(self, request):
        """
        :rtype: list[wshop.admin.base.MenuEntry]
        """
        return ()

    def get_search_results(self, request, query):
        """
        :rtype: list[wshop.admin.base.SearchResult]
        """
        return ()

    def get_dashboard_blocks(self, request):
        """
        :rtype: list[wshop.admin.dashboard.DashboardBlock]
        """
        return ()
    ...
    def get_help_blocks(self, request, kind):
        ...
        :type kind: str
        :rtype: list[wshop.admin.views.home.HelpBlock]
        """
        return ()
    ...
    def get_notifications(self, request):
        """
        :rtype: list[wshop.admin.base.Notification]
        """
        return ()
    ...
    def get_activity(self, request, cutoff):
        ...
        :param request: Request
        :type request: django.http.request.HttpRequest
        :return: list[wshop.admin.base.Activity]
        """
        return ()
    ...
    def get_model_url(self, object, kind, shop=None):
        ...
        :type shop: wshop.core.models.Shop|None
...
class Section(object):
    ...
    def visible_for_object(cls, obj, request=None):
        ...
        :type model object: e.g. wshop.core.models.Order
    ...
    def get_context_data(cls, obj, request=None):
        ...
        :type object: e.g. wshop.core.models.Order
        :type request: HttpRequest
