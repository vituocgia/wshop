...
class Price(Money):
    ...
    will raise an :obj:`~wshop.utils.numbers.UnitMixupError`.

    In addition to `includes_tax` info, Prices are Money and know their
    `~wshop.utils.numbers.UnittedDecimal.value` and
    `~wshop.utils.money.Money.currency`.  To get the bare Money amount
