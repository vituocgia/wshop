...
"""
Wshop modular product pricing functionality.

The pricing module in use is declared by the
:obj:`~wshop.core.settings.WSHOP_PRICING_MODULE` setting.  The
default is a pricing module that always prices everything to be free.
The base distribution contains :obj:`wshop.customer_group_pricing`, which is an
...
(:class:`~wshop.core.models.Product` objects contain the
convenience methods
:func:`~wshop.core.models.Product.get_price_info`,
:func:`~wshop.core.models.Product.get_price`,
and :func:`~wshop.core.models.Product.get_base_price`
