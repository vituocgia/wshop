...
class Priceful(object):
     ...
     * ``base_unit_price`` (`~wshop.core.pricing.Price`) and
     * ``discount_amount`` (`~wshop.core.pricing.Price`)

    or both

     * ``price`` (`~wshop.core.pricing.Price`) and
     * ``base_price`` (`~wshop.core.pricing.Price`).

    You may also provide

     * ``tax_amount`` (`~wshop.utils.money.Money`)
