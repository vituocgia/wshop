...
from wshop.core.order_creator import OrderSource, SourceLine
...
from wshop.utils.objects import compare_partial_dicts
...
class BaseBasket(OrderSource):
    ...
    def save(self):
        ...
        :obj:`~wshop.front.middleware.WshopFrontMiddleware` will usually
        take care of it.
        """
