...
def forwards_func(apps, schema_editor):
    OrderStatus = apps.get_model("wshop", "OrderStatus")
    OrderStatusTranslation = apps.get_model("wshop", "OrderStatusTranslation")
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='orderstatus',
            name='role',
            field=enumfields.fields.EnumIntegerField(db_index=True, default=0, enum=wshop.core.models.OrderStatusRole, help_text='Role of status. One role can have multiple order statuses.', verbose_name='role'),
        ),
        migrations.AlterField(
            model_name='orderstatustranslation',
            name='name',
