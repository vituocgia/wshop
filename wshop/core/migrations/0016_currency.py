    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', enumfields.fields.EnumIntegerField(default=0, enum=wshop.utils.analog.LogEntryKind, verbose_name='log entry kind')),
                ('extra', jsonfield.fields.JSONField(blank=True, null=True, verbose_name='extra data')),
                ('target', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='log_entries', to='wshop.Currency', verbose_name='target')),
