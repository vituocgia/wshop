    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shops', models.ManyToManyField(help_text='Select which shops you would like the files to be visible in.', related_name='media_files', to='wshop.Shop', verbose_name='shops')),
            ],
        ),
        migrations.CreateModel(
            name='MediaFolder',
            fields=[
                ...
                ('shops', models.ManyToManyField(help_text='Select which shops you would like the folder to be visible in.', related_name='media_folders', to='wshop.Shop', verbose_name='shops')),
            ],
        ),
    ]
