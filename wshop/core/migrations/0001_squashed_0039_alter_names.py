...
LANGUAGE_CHOICES = [
    (code, code)
    for code in sorted(wshop.core.fields.LanguageFieldMixin.LANGUAGE_CODES)
]


def ensure_default_currencies_exists(apps, schema_editor):
    Currency = apps.get_model("wshop", "Currency")
...
class Migration(migrations.Migration):
    replaces = [
        ('wshop', '0001_initial'),
        ('wshop', '0002_rounding'),
        ('wshop', '0003_shopproduct_backorder_maximum'),
        ('wshop', '0004_update_orderline_refunds'),
        ('wshop', '0005_shopproduct_visibilty'),
        ('wshop', '0006_logmodels'),
        ('wshop', '0007_shop_languages_config'),
        ('wshop', '0008_blank_slugs_for_product'),
        ('wshop', '0009_update_tax_name_max_length'),
        ('wshop', '0010_update_managers'),
        ('wshop', '0011_remove_product_category'),
        ('wshop', '0012_contact_language'),
        ('wshop', '0013_product_shipping_mode_default'),
        ('wshop', '0014_order_status'),
        ('wshop', '0015_shipment_type'),
        ('wshop', '0016_currency'),
        ('wshop', '0017_ensure_currencies_exists'),
        ('wshop', '0018_visibility_defaults'),
        ('wshop', '0019_order_total_limit_behavior_component'),
        ('wshop', '0020_md_to_html'),
        ('wshop', '0021_country_limit_behavior_component'),
        ('wshop', '0022_add_favicon'),
        ('wshop', '0023_category_menu_visibility'),
        ('wshop', '0024_product_shop_description'),
        ('wshop', '0025_product_variation_ordering'),
        ('wshop', '0026_address_geolocation'),
        ('wshop', '0027_modify_shop_fields'),
        ('wshop', '0028_displayunit'),
        ('wshop', '0029_personcontact_names'),
        ('wshop', '0030_add_db_indices'),
        ('wshop', '0031_basket'),
        ('wshop', '0032_shop_product_fields'),
        ('wshop', '0033_order_modified_date'),
        ('wshop', '0034_shops_for_supplier'),
        ('wshop', '0035_remove_shop_permissions'),
        ('wshop', '0036_shop_contacts'),
        ('wshop', '0037_modified_on_contact'),
        ('wshop', '0038_order_date_index'),
        ('wshop', '0039_alter_names'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', enumfields.fields.EnumIntegerField(
                    ...
                    verbose_name='type',
                    enum=wshop.core.models.AttributeType,
                    default=20)),
                ('visibility_mode', enumfields.fields.EnumIntegerField(
                    ...
                    enum=wshop.core.models.AttributeVisibility,
                    default=1)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(
                    ...
                    db_index=True,
                    max_length=32,
                    default=wshop.core.models._basket.generate_key)),
                ('created_on', models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', enumfields.fields.EnumIntegerField(
                    ...
                    db_index=True,
                    verbose_name='status',
                    enum=wshop.core.models.CategoryStatus,
                    default=1)),
                ...
                ('visibility', enumfields.fields.EnumIntegerField(
                    ...
                    enum=wshop.core.models.CategoryVisibility,
                    default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(
                    ...
                    db_index=True,
                    default=True)),
                ('_language', wshop.core.fields.LanguageField(
                    help_text=
                ...
                ('merchant_notes', models.TextField(
                    help_text=
                    'Enter any private notes for this customer that are only accessible in Wshop admin.',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', enumfields.fields.EnumIntegerField(
                    ...
                    primary_key=True,
                    serialize=False,
                    enum=wshop.core.models.CounterType)),
        ...
        migrations.CreateModel(
            ...
            bases=(wshop.core.models._base.ChangeProtected,
                   wshop.core.utils.name_mixin.NameMixin, models.Model),),
        migrations.CreateModel(
            name='Manufacturer',
            fields=[
                ('id', models.AutoField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prices_include_tax', models.BooleanField(
                    verbose_name='prices include tax')),
                ('display_currency', wshop.core.fields.CurrencyField(
                ...
                ('language', wshop.core.fields.LanguageField(
                    verbose_name='language',
                    choices=LANGUAGE_CHOICES,
                    max_length=10,
                    blank=True)),
                ...
                ('billing_address', models.ForeignKey(
                    ...
                    to='wshop.ImmutableAddress',
                    blank=True,
                    verbose_name='billing address',
                    on_delete=django.db.models.deletion.PROTECT,
                    null=True)),
                ('creator', wshop.core.fields.UnsavedForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', enumfields.fields.EnumIntegerField(
                    ...
                    enum=wshop.core.models.OrderLineType,
                    default=1)),
                ...
                ('quantity', wshop.core.fields.QuantityField(
                    ...
                    max_digits=36,
                    default=1)),
                ('base_unit_price_value', wshop.core.fields.MoneyValueField(
                ...
                ('discount_amount_value', wshop.core.fields.MoneyValueField(
                    ...
                    max_digits=36,
                    default=0)),
                ('order', wshop.core.fields.UnsavedForeignKey(
                    on_delete=django.db.models.deletion.PROTECT,
                    to='wshop.Order',
                    related_name='lines',
                    verbose_name='order')),
                ('parent_line', wshop.core.fields.UnsavedForeignKey(
            ...
            bases=(wshop.core.utils.line_unit_mixin.LineWithUnit,
                   wshop.utils.properties.MoneyPropped, models.Model,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_value', wshop.core.fields.MoneyValueField(
                    ...
                    max_digits=36)),
                ('base_amount_value', wshop.core.fields.MoneyValueField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', enumfields.fields.EnumIntegerField(
                    ...
                    db_index=True,
                    verbose_name='role',
                    enum=wshop.core.models.OrderStatusRole,
                    default=0)),
                ('default', models.BooleanField(
                    help_text=
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foreign_amount_value', wshop.core.fields.MoneyValueField(
                    decimal_places=9,
                    max_digits=36,
                    blank=True,
                    ...
                    null=True,
                    default=None)),
                ('foreign_currency', wshop.core.fields.CurrencyField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode', enumfields.fields.EnumIntegerField(
                    verbose_name='mode',
                    enum=wshop.core.models.ProductMode,
                    default=0)),
                ('stock_behavior', enumfields.fields.EnumIntegerField(
                    help_text=
                    'Set to stocked if inventory should be managed within Wshop.',
                    verbose_name='stock',
                    enum=wshop.core.models.StockBehavior,
                    default=0)),
                ('shipping_mode', enumfields.fields.EnumIntegerField(
                    ...
                    enum=wshop.core.models.ShippingMode,
                    default=1)),
                ('sku', models.CharField(
                    help_text=
                ...
                ('width', wshop.core.fields.MeasurementField(
                    help_text=
                    ...
                    default=0)),
                ('height', wshop.core.fields.MeasurementField(
                    help_text=
                    ...
                    default=0)),
                ('depth', wshop.core.fields.MeasurementField(
                    help_text=
                    ...
                    default=0)),
                ('net_weight', wshop.core.fields.MeasurementField(
                    help_text=
                    ...
                    default=0)),
                ('gross_weight', wshop.core.fields.MeasurementField(
                    help_text=
            ...
            bases=(wshop.core.taxing.TaxableItem,
                   wshop.core.models._attributes.AttributableMixin,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute', models.ForeignKey(
                    verbose_name='attribute', to='wshop.Attribute')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', enumfields.fields.EnumIntegerField(
                    verbose_name='type',
                    enum=wshop.core.models.ProductCrossSellType)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', enumfields.fields.EnumIntegerField(
                    ...
                    db_index=True,
                    verbose_name='kind',
                    enum=wshop.core.models.ProductMediaKind,
                    default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', enumfields.fields.EnumIntegerField(
                    ...
                    db_index=True,
                    default=1,
                    enum=wshop.core.models.ProductVariationLinkStatus)),
                ('product', models.ForeignKey(
                    to='wshop.Product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(verbose_name='name',
                                          max_length=128)),
                ('master', models.ForeignKey(
                    to='wshop.ProductVariationVariable',
                    related_name='translations',
                    editable=False,
                    null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(
                    to='wshop.ProductVariationVariableValue',
                    related_name='translations',
                    editable=False,
                    null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            bases=(wshop.core.models._units._ShortNameToSymbol,
                   parler.models.TranslatableModelMixin, models.Model),),
        migrations.CreateModel(
            ...
            bases=(wshop.core.models._units._ShortNameToSymbol, models.Model),
        ),
        migrations.CreateModel(
            name='SavedAddress',
            fields=[
                ...
                ('role', enumfields.fields.EnumIntegerField(
                    verbose_name='role',
                    enum=wshop.core.models.SavedAddressRole,
                    default=1)),
                ('status', enumfields.fields.EnumIntegerField(
                    verbose_name='status',
                    enum=wshop.core.models.SavedAddressStatus,
                    default=1)),
                ('title', models.CharField(
                    verbose_name='title', max_length=255, blank=True)),
                ('address', models.ForeignKey(
                    to='wshop.MutableAddress',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', enumfields.fields.EnumIntegerField(
                    verbose_name='status',
                    enum=wshop.core.models.ShipmentStatus,
                    default=0)),
                ('tracking_code', models.CharField(
                    verbose_name='tracking code', max_length=64, blank=True)),
                ('description', models.CharField(
                    verbose_name='description', max_length=255, blank=True)),
                ('volume', wshop.core.fields.MeasurementField(
                    verbose_name='volume',
                    unit='m3',
                    decimal_places=9,
                    max_digits=36,
                    default=0)),
                ('weight', wshop.core.fields.MeasurementField(
                    verbose_name='weight',
                    unit='kg',
                    decimal_places=9,
                    max_digits=36,
                ...
                ('type', enumfields.fields.EnumIntegerField(
                    verbose_name='type',
                    enum=wshop.core.models.ShipmentType,
                    default=0)),
                ('order', models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', wshop.core.fields.QuantityField(
                    ...
                    max_digits=36,
                    default=0)),
                ('unit_volume', wshop.core.fields.MeasurementField(
                    verbose_name='unit volume',
                    unit='m3',
                    decimal_places=9,
                    max_digits=36,
                    default=0)),
                ('unit_weight', wshop.core.fields.MeasurementField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', enumfields.fields.EnumIntegerField(
                    ...
                    verbose_name='status',
                    enum=wshop.core.models.ShopStatus,
                    default=0)),
                ...
                ('currency', wshop.core.fields.CurrencyField(
                    ...
                    verbose_name='currency',
                    max_length=4,
                    default=wshop.core.models._shops._get_default_currency)),
                ('prices_include_tax', models.BooleanField(
                    help_text=
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visibility', enumfields.fields.EnumIntegerField(
                    ...
                    enum=wshop.core.models.ShopProductVisibility,
                    default=3)),
                ...
                ('visibility_limit', enumfields.fields.EnumIntegerField(
                    ...
                    db_index=True,
                    verbose_name='visibility limitations',
                    enum=wshop.core.models.ProductVisibility,
                    default=1)),
                ('backorder_maximum', wshop.core.fields.QuantityField(
                    help_text=
                    ...
                    null=True,
                    default=0)),
                ('purchase_multiple', wshop.core.fields.QuantityField(
                    help_text=
                    ...
                    max_digits=36,
                    default=0)),
                ('minimum_purchase_quantity', wshop.core.fields.QuantityField(
                    help_text=
                ...
                ('limit_payment_methods', models.BooleanField(
                    ...
                    default=False)),
                ('default_price_value', wshop.core.fields.MoneyValueField(
                    help_text=
                    ...
                    null=True)),
                ('minimum_price_value', wshop.core.fields.MoneyValueField(
                    help_text=
                ...
                ('primary_category', models.ForeignKey(
                    ...
                    on_delete=django.db.models.deletion.PROTECT,
                    null=True)),
                ('product', wshop.core.fields.UnsavedForeignKey(
                    to='wshop.Product',
                    related_name='shop_products',
                    verbose_name='product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logical_count', wshop.core.fields.QuantityField(
                    ...
                    default=0)),
                ('product', models.ForeignKey(
                    verbose_name='product', to='wshop.Product')),
            ],),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', enumfields.fields.EnumIntegerField(
                    ...
                    enum=wshop.core.models.SupplierType,
                    default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(
                    ...
                    primary_key=True,
                    serialize=False)),
                ('code', wshop.core.fields.InternalIdentifierField(
                    unique=True,
                    blank=True,
                    max_length=64,
                    editable=False,
            ...
            bases=(wshop.utils.properties.MoneyPropped,
                   wshop.core.models._base.ChangeProtected,
                   parler.models.TranslatableModelMixin, models.Model),),
        migrations.CreateModel(
            name='TaxClass',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(
                    ...
                    primary_key=True,
                    serialize=False)),
                ('min_value', wshop.core.fields.MeasurementField(
                    help_text=
                    ...
                    null=True,
                    default=0)),
                ('max_value', wshop.core.fields.MeasurementField(
                    help_text=
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(
                    ...
                    blank=True)),
                ('master', models.ForeignKey(
                    to='wshop.WeightBasedPriceRange',
                    related_name='translations',
                    editable=False,
                    null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('servicebehaviorcomponent_ptr', models.OneToOneField(
                    ...
                    primary_key=True,
                    serialize=False)),
                ('min_price_value', wshop.core.fields.MoneyValueField(
                    verbose_name='min price value',
                    decimal_places=9,
                    null=True,
                    max_digits=36,
                    blank=True)),
                ('max_price_value', wshop.core.fields.MoneyValueField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_value', wshop.core.fields.MoneyValueField(
                    ...
                    decimal_places=9,
                    max_digits=36)),
                ('waive_limit_value', wshop.core.fields.MoneyValueField(
                    help_text=
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name='polymorphic_wshop.serviceprovider_set+',
                editable=False,
                null=True),),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to='contenttypes.ContentType',
                related_name='polymorphic_wshop.servicebehaviorcomponent_set+',
                editable=False,
                null=True),),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='product',
            field=wshop.core.fields.UnsavedForeignKey(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to='contenttypes.ContentType',
                related_name='polymorphic_wshop.contact_set+',
                editable=False,
                null=True),),
        migrations.AddField(
            model_name='contact',
        ...
        migrations.AddField(
            ...
            name='products',
            field=models.ManyToManyField(
                verbose_name='products', to='wshop.Product', blank=True),),
        migrations.AddField(
            model_name='basket',
            name='shop',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rounding_mode', enumfields.fields.EnumField(
                    ...
                    max_length=50,
                    enum=wshop.core.models._service_payment.RoundingMode,
        ...
        migrations.AddField(
            ...
            name='component',
            field=models.ForeignKey(
                to='wshop.WeightBasedPricingBehaviorComponent',
                related_name='ranges'),),
        migrations.AddField(
            model_name='waivingcostbehaviorcomponenttranslation',
            name='master',
            field=models.ForeignKey(
                to='wshop.WaivingCostBehaviorComponent',
                related_name='translations',
                editable=False,
                null=True),),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddField(
            ...
            name='master',
            field=models.ForeignKey(
                to='wshop.FixedCostBehaviorComponent',
                related_name='translations',
                editable=False,
                null=True),),
        migrations.AlterUniqueTogether(
