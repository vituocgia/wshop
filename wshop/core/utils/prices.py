...
def convert_taxness(request, item, priceful, with_taxes):
    ...
    :type priceful: wshop.core.pricing.Priceful
    :type with_taxes: bool|None
    :rtype: wshop.core.pricing.Priceful
    """
...
def _make_taxed(request, item, priceful, with_taxes):
    ...
    :type item: wshop.core.taxing.TaxableItem
    :type priceful: wshop.core.pricing.Priceful
    :rtype: wshop.core.pricing.Priceful|None
    """
    try:
        tax_amount = getattr(priceful, 'tax_amount', None)
    except TypeError:  # e.g. wshop.core.order_creator.TaxesNotCalculated
        tax_amount = None
