...
from wshop.core.fields.utils import ensure_decimal_places
...
from wshop.core.pricing import Price, Priceful, TaxfulPrice, TaxlessPrice
from wshop.core.taxing import should_calculate_taxes_automatically, TaxableItem
from wshop.core.utils.line_unit_mixin import LineWithUnit
from wshop.utils.decorators import non_reentrant
from wshop.utils.i18n import format_money, is_existing_language
...
class OrderSource(object):
    ...
    def smart_product_count(self):
        ...
        `~wshop.core.models.UnitInteface.allow_bare_number`) and its
...
class SourceLine(TaxableItem, Priceful, LineWithUnit):
    ...
    def taxes(self):
        ...
        :rtype: list[wshop.core.taxing.LineTax]
        """
