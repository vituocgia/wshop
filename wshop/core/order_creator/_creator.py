...
from wshop.core.models import Order, OrderLine, OrderLineType, ShopProduct
from wshop.core.order_creator.signals import (
...
from wshop.core.utils.users import real_user_or_none
...
class OrderProcessor(object):
    ...
    def get_source_base_data(self, order_source):
        """
        :type order_source: wshop.core.order_creator.OrderSource
        """
        return dict(
    ...
    def __init__(self, request=None):
        ...
        if request is not None:
            warnings.warn(
                ...
                RemovedFromWshopWarning, stacklevel=2)
