...
from wshop.core.fields import MoneyValueField, QuantityField, UnsavedForeignKey
from wshop.core.pricing import Priceful
from wshop.core.taxing import LineTax
from wshop.core.utils.line_unit_mixin import LineWithUnit
from wshop.utils.analog import define_log_model
from wshop.utils.money import Money
from wshop.utils.properties import MoneyProperty, MoneyPropped, PriceProperty

from ._base import WshopModel
...
class AbstractOrderLine(MoneyPropped, models.Model, Priceful):
    product = UnsavedForeignKey(
        "wshop.Product", blank=True, null=True, related_name="order_lines",
        on_delete=models.PROTECT, verbose_name=_('product')
    )
    supplier = UnsavedForeignKey(
        "wshop.Supplier", blank=True, null=True, related_name="order_lines",
