...
from wshop.core.fields import InternalIdentifierField, LanguageField
from wshop.core.pricing import PriceDisplayOptions
from wshop.utils.analog import define_log_model

from ._base import PolymorphicWshopModel, TranslatableWshopModel
...
class ContactGroup(TranslatableWshopModel):
...
class Contact(PolymorphicWshopModel):
    is_anonymous = False
    is_all_seeing = False
    ...
    shops = models.ManyToManyField("wshop.Shop", blank=True, verbose_name=_('shops'), help_text=_(
