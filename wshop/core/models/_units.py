...
from wshop.core.fields import InternalIdentifierField, QuantityField
from wshop.utils.i18n import format_number
from wshop.utils.numbers import bankers_round, parse_decimal_string

from ._base import TranslatableWshopModel
...
class SalesUnit(_ShortNameToSymbol, TranslatableWshopModel):
...
class DisplayUnit(TranslatableWshopModel):
