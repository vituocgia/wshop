...
from wshop.core.utils.name_mixin import NameMixin
from wshop.utils.analog import define_log_model
from wshop.utils.importing import cached_load
from wshop.utils.models import get_data_dict

from ._base import ChangeProtected, WshopModel
...
class Address(NameMixin, WshopModel):
    """
    ...
    @property
    def is_home(self):
        if not settings.WSHOP_ADDRESS_HOME_COUNTRY:
            return False
        return self.country.code == settings.WSHOP_ADDRESS_HOME_COUNTRY.upper()
