...
from wshop.utils.i18n import format_money, format_percent
from wshop.utils.properties import MoneyProperty, MoneyPropped

from ._base import ChangeProtected, TranslatableWshopModel
...
class TaxClass(TranslatableWshopModel):
...
class CustomerTaxGroup(TranslatableWshopModel):
    identifier = InternalIdentifierField(unique=True)
    translations = TranslatedFields(
        name=models.CharField(max_length=100, verbose_name=_('name'), help_text=_(
