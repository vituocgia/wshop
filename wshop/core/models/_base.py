...
from wshop.utils import text


class WshopModel(models.Model):
    """
    Wshop Model.
    """
...
class TranslatableWshopModel(WshopModel, parler.models.TranslatableModel):
    name_attr = 'name'
...
class PolymorphicWshopModel(PolymorphicModel, WshopModel):
    class Meta:
        abstract = True
...
class PolymorphicTranslatableWshopModel(six.with_metaclass(
        PolyTransModelBase,
        PolymorphicWshopModel, TranslatableWshopModel)):
