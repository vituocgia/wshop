...
from wshop.core.fields import InternalIdentifierField
from wshop.core.pricing import PriceInfo

from ._base import (
    PolymorphicWshopModel, PolymorphicTranslatableWshopModel,
    PolyTransModelBase, TranslatableWshopModel
)
from ._product_shops import ShopProduct
from ._shops import Shop


class ServiceProvider(PolymorphicTranslatableWshopModel):
    """
    ...
    def create_service(self, choice_identifier, **kwargs):
        ...
        :rtype: wshop.core.models.Service
        """
    ...
    def get_effective_name(self, service, source):
        ...
        :type service: wshop.core.models.Service
...
class Service(TranslatableWshopModel):
    """
    ...
    def provider(self):
        """
        :rtype: wshop.core.models.ServiceProvider
        """
    ...
    def get_effective_name(self, source):
        ...
        for `~wshop.core.models.ServiceProvider.get_effective_name`
    ...
    def get_lines(self, source):
        ...
        :type source: wshop.core.order_creator.OrderSource
        :rtype: Iterable[wshop.core.order_creator.SourceLine]
        """
...
class ServiceCost(object):
    ...
    def __init__(
        ...
        :type price: wshop.core.pricing.Price
        :type description: str|None
        :type tax_class: wshop.core.models.TaxClass|None
        :type base_price: wshop.core.pricing.Price|None
        """
...
class ServiceBehaviorComponent(PolymorphicWshopModel):
    ...
    def get_delivery_time(self, service, source):
        ...
        :type service: Service
        :type source: wshop.core.order_creator.OrderSource
        :rtype: wshop.utils.dates.DurationRange|None
        """
        return None
...
class TranslatableServiceBehaviorComponent(six.with_metaclass(
        PolyTransModelBase,
        ServiceBehaviorComponent, TranslatableWshopModel)):
    class Meta:
        abstract = True
