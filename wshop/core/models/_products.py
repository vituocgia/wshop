...
from wshop.core.excs import ImpossibleProductModeException
from wshop.core.fields import InternalIdentifierField, MeasurementField
from wshop.core.signals import post_clean, pre_clean
from wshop.core.taxing import TaxableItem
from wshop.core.utils import context_cache
from wshop.core.utils.slugs import generate_multilanguage_slugs
...
class Product(TaxableItem, AttributableMixin, TranslatableModel):
    ...
    stock_behavior = EnumIntegerField(
        ...
        help_text=_("Set to stocked if inventory should be managed within Wshop.")
    )
    ...
    def get_priced_children(self, context, quantity=1):
        ...
        :return:
          ...
          most expensive.
        """
        from wshop.core.models import ShopProduct
        priced_children = []
    ...
    def get_child_price_range(self, context, quantity=1):
        ...
        :type context: wshop.core.pricing.PricingContextable
        :type quantity: int
        :return: a tuple of prices
        :rtype: (wshop.core.pricing.Price, wshop.core.pricing.Price)
        """
    ...
    def get_cheapest_child_price_info(self, context, quantity=1):
        ...
        :type context: wshop.core.pricing.PricingContextable
        :rtype: wshop.core.pricing.PriceInfo
        """
        items = [c.get_price_info(context, quantity=quantity) for c in self.variation_children.all()]
        if not items:
            return None
    ...
    def get_price_info(self, context, quantity=1):
        ...
        :rtype: wshop.core.pricing.PriceInfo
        """
        from wshop.core.pricing import get_price_info
    ...
    def get_price(self, context, quantity=1):
        ...
        :type context: wshop.core.pricing.PricingContextable
        :rtype: wshop.core.pricing.Price
        """
