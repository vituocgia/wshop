...
from wshop.core.templatetags.wshop_common import datetime as format_datetime
from wshop.core.templatetags.wshop_common import number as format_number
from wshop.utils.analog import define_log_model
from wshop.utils.dates import parse_date
from wshop.utils.numbers import parse_decimal_string
...
class AttributableMixin(object):
    ...
    def cache_attributes_for_targets(
        ...
        if not settings.WSHOP_ENABLE_ATTRIBUTES:  # pragma: no cover
            return targets
