...
from wshop.core.models import WshopModel
from wshop.core.signals import shipment_deleted
...
class Shipment(WshopModel):
    ...
    def set_received(self, purchase_prices=None, created_by=None):
        ...
        :type purchase_prices: dict[wshop.shop.models.Product, decimal.Decimal]
...
class ShipmentProduct(WshopModel):
