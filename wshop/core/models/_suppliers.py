...
from wshop.core.modules import ModuleInterface
...
class Supplier(ModuleInterface, WshopModel):
    default_module_spec = "wshop.core.suppliers:BaseSupplierModule"
    ...
    def get_orderability_errors(self, shop_product, quantity, customer):
        ...
        :type contect: wshop.core.models.Contact
    ...
    def adjust_stock(self, product_id, delta, created_by=None, type=None):
        from wshop.core.suppliers.base import StockAdjustmentType
