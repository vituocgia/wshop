...
from wshop.apps.provides import load_module
...
def get_tax_module():
    ...
    :rtype: wshop.core.taxing.TaxModule
    """
    return load_module("WSHOP_TAX_MODULE", "tax_module")()


def should_calculate_taxes_automatically():
    """
    If ``settings.WSHOP_CALCULATE_TAXES_AUTOMATICALLY_IF_POSSIBLE``
    ...
    :rtype: bool
    """
    if not settings.WSHOP_CALCULATE_TAXES_AUTOMATICALLY_IF_POSSIBLE:
        return False
...
class TaxModule(six.with_metaclass(abc.ABCMeta)):
    ...
    def add_taxes(self, source, lines):
        ...
        :type lines: list[wshop.core.order_creator.SourceLine]
    ...
    def _get_line_taxes(self, context, line):
        ...
        :type line: wshop.core.order_creator.SourceLine
    ...
    def get_taxed_price(self, context, price, tax_class):
        ...
        :type tax_class: wshop.core.models.TaxClass
