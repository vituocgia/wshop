...
from wshop.core.api.front_orders import OrderLineSerializer
from wshop.core.models import OrderLineTax, Tax, TaxClass
...
class TaxSummarySerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        from wshop.core.taxing._tax_summary import TaxSummaryLine
