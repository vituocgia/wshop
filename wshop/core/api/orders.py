...
from wshop.admin.modules.orders.json_order_creator import JsonOrderCreator
from wshop.admin.modules.orders.views.edit import encode_address
from wshop.api.mixins import PermissionHelperMixin, ProtectedModelViewSetMixin
from wshop.core.api.address import AddressSerializer
from wshop.core.api.mixins import AvailableOrderMethodsMixin
from wshop.core.api.refunds import RefundMixin
...
class OrderTaxesMixin(object):
    ...
    def taxes(self, request, pk=None):
        ...
        Get taxes for order
        """
        from wshop.core.api.tax import OrderLineTaxSerializer, TaxSummarySerializer
        order = self.get_object()
