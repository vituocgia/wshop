...
from wshop.api.fields import FormattedDecimalField
...
from wshop.core.utils.product_statistics import get_best_selling_product_info
...
class ClosestShopFilter(filters.BaseFilterBackend):
    ...
    Based of `wshop.core.api.shop.NearbyShopsFilter`
    """
    def filter_queryset(self, request, queryset, view):
