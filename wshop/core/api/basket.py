...
from wshop.api.decorators import schema_serializer_class
from wshop.api.fields import EnumField, FormattedDecimalField
from wshop.api.mixins import PermissionHelperMixin
from wshop.core.api.address import AddressSerializer
from wshop.core.api.contacts import PersonContactSerializer
from wshop.core.api.tax import SourceLineTaxSerializer, TaxSummarySerializer
from wshop.core.basket import (
    get_basket_command_dispatcher, get_basket_order_creator
)
from wshop.core.basket.storage import BasketCompatibilityError, get_storage
from wshop.core.excs import ProductNotOrderableProblem
...
class BasketViewSet(PermissionHelperMixin, viewsets.GenericViewSet):
    ...
    def get_basket_shop(self):
        if settings.WSHOP_ENABLE_MULTIPLE_SHOPS:
            shop_id = None
    ...
    def abandoned(self, request, *args, **kwargs):
        if settings.WSHOP_BASKET_STORAGE_CLASS_SPEC != "wshop.core.basket.storage:DatabaseBasketStorage":
