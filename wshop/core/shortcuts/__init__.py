...
def update_order_line_from_product(
    ...
    :type pricing_context: wshop.core.pricing.PricingContextable|None
    ...
    :type order_line: wshop.core.models.OrderLine
    :type product: wshop.core.models.Product
    :type quantity: int|decimal.Decimal
    :type supplier: wshop.core.models.Supplier|None
    """
