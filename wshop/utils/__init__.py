...
def update_module_attributes(object_names, module_name):
    ...
    Use case for this function in Wshop is to hide the actual location
...
class WshopUtilsAppConfig(wshop.apps.AppConfig):
    name = __name__
    verbose_name = _("Wshop Utilities")
    label = "wshop_utils"


default_app_config = __name__ + ".WshopUtilsAppConfig"
