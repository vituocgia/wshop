...
from wshop.reports.utils import parse_date_range
from wshop.reports.writer import get_writer_names
...
class BaseReportForm(forms.Form):
    ...
    def get_report_instance(self):
        """
        :rtype: wshop.reports.reporter.base.WshopReportBase
        """
        from wshop.reports.report import get_report_class
