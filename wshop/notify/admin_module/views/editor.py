...
from wshop.admin.utils.views import get_create_or_change_title
from wshop.notify.admin_module.forms import ScriptItemEditForm
from wshop.notify.admin_module.utils import get_enum_choices_dict
from wshop.notify.base import Action, Condition, Event
from wshop.notify.enums import StepConditionOperator, StepNext
from wshop.notify.models.script import Script
from wshop.utils.text import snake_case
...
class ScriptAPI(object):
    def __init__(self, request, script):
        ...
        :param script: Script
        :type script: wshop.notify.models.Script
        """
