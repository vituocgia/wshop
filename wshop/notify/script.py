...
from wshop.notify.base import Action, Condition
from wshop.notify.enums import StepConditionOperator, StepNext
from wshop.utils.analog import BaseLogEntry
...
class Context(object):
    ...
    def from_variables(cls, shop=None, **variables):
        ...
        :rtype: wshop.notify.script.Context
        """
    ...
    def from_event(cls, event, shop=None):
        ...
        :type event: wshop.notify.Event
        :type shop: wshop.Shop
        :rtype: wshop.notify.script.Context
        """
