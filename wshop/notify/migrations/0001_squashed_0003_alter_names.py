...
class Migration(migrations.Migration):
    replaces = [
        ('wshop_notify', '0001_initial'),
        ('wshop_notify', '0002_notify_script_template'),
        ('wshop_notify', '0003_alter_names'),
    ]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient_type', enumfields.fields.EnumIntegerField(
                    ...
                    enum=wshop.notify.enums.RecipientType)),
                ...
                ('priority', enumfields.fields.EnumIntegerField(
                    ...
                    db_index=True,
                    enum=wshop.notify.enums.Priority)),
