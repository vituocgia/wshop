...
from wshop.apps.provides import get_identifier_to_object_map
from wshop.notify.enums import (
    ConstantUse, TemplateUse, UNILINGUAL_TEMPLATE_LANGUAGE
)
from wshop.notify.template import render_in_context, Template
from wshop.utils.text import snake_case, space_case
...
class Action(ScriptItem):
    ...
    def get_template(self, context):
        ...
        :rtype: wshop.notify.template.Template
        """
...
class ScriptTemplate(six.with_metaclass(abc.ABCMeta)):
    ...
    :ivar wshop.notify.Event event: the event class which will be used to trigger the notification
    ...
    def __init__(self, script_instance=None):
        """
        :param wshop.notify.models.script.Script|None script_instance: script instance to change or None
        """
    ...
    def create_script(self, shop, form=None):
        ...
        :rtype: wshop.notify.models.script.Script
        """
        pass
