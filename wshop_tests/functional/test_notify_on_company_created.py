...
from wshop.front.apps.customer_information.notify_events import CompanyAccountCreated
from wshop.notify.actions.notification import AddNotification
from wshop.notify.models import Notification
from wshop.notify.enums import StepConditionOperator, StepNext
