...
from wshop.testing.browser_utils import wait_until_appeared
from wshop.core.models import CategoryStatus
...
def test_recently_viewed_products(browser, live_server, settings):
    ...
    category.save()
    category_url = reverse("wshop:category", kwargs={"pk": category.pk, "slug": category.slug})
