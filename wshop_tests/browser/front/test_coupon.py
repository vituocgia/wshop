...
from wshop.campaigns.models.catalog_filters import (
    CategoryFilter
)
from wshop.campaigns.models.product_effects import (
    ProductDiscountAmount
)

from wshop.core import cache
from wshop.core.models import Category, CategoryStatus, Product
...
from wshop.testing.utils import initialize_front_browser_test
...
def _add_product_to_basket_from_category(live_server, browser, first_category, shop):
    url = reverse("wshop:category", kwargs={"pk": first_category.pk, "slug": first_category.slug})
