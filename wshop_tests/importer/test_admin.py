...
from wshop.importer.admin_module.import_views import ImportView
...
def do_importing(sku, name, lang, shop, import_mode=ImportMode.CREATE_UPDATE, client=None):
    ...
    is_update = True
    import_path = reverse("wshop_admin:importer.import")
    process_path = reverse("wshop_admin:importer.import_process")
