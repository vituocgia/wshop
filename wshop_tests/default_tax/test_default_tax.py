...
from wshop.core.taxing import get_tax_module, TaxingContext
from wshop.default_tax.admin_module.views import TaxRuleEditView
from wshop.default_tax.models import TaxRule
from wshop.default_tax.module import (
    DefaultTaxModule, get_taxes_of_effective_rules
)
from wshop.testing.factories import create_product, get_default_shop, get_shop
from wshop.testing.utils import apply_request_middleware
from wshop.utils.money import Money
from wshop_tests.utils.forms import get_form_data
...
def test_module(address, expected_taxes):
    ...
    with override_settings(WSHOP_TAX_MODULE='default_tax'):
