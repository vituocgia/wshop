...
from wshop.core.pricing import PriceInfo, TaxfulPrice, TaxlessPrice
from wshop.core.taxing import SourceLineTax, TaxedPrice, TaxModule
from wshop.core.utils.prices import convert_taxness
from wshop.utils import babel_precision_provider
from wshop.utils.money import Money, set_precision_provider
from wshop.testing.factories import get_currency



TAX_MODULE_SPEC = __name__ + ':DummyTaxModule'

original_tax_module = settings.WSHOP_TAX_MODULE
...
def teardown_module(module):
    ...
    settings.WSHOP_TAX_MODULE = original_tax_module
