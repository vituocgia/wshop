...
from wshop.core.order_creator import OrderSource
from wshop.core.pricing import (
    get_pricing_module, PriceDisplayOptions, PriceInfo, PricingModule,
    TaxfulPrice, TaxlessPrice
)
from wshop.front.basket.objects import BaseBasket
...
original_discount_modules = settings.WSHOP_DISCOUNT_MODULES
pricing_overrider = override_provides("pricing_module", [PRICING_MODULE_SPEC])


def setup_module(module):
    settings.WSHOP_PRICING_MODULE = "dummy_pricing_module"
    settings.WSHOP_DISCOUNT_MODULES = []
...
def teardown_module(module):
    ...
    settings.WSHOP_DISCOUNT_MODULES = original_discount_modules
