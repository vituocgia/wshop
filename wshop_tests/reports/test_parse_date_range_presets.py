...
from wshop.utils import i18n
from wshop.reports.forms import DateRangeChoices
from wshop.reports.utils import parse_date_range_preset
...
def test_parse_date_range_presets_running_week(locale):
    ...
    with mock.patch("wshop.utils.i18n.get_current_babel_locale", side_effect=get_locale):
