...
from wshop.notify.base import Action, Event, Variable
...
from wshop.notify.template import Template
from wshop.notify.typology import Language, Model, Text
...
class ATestEvent(Event):
    ...
    order = Variable(name="Order", type=Model("wshop.Order"))
