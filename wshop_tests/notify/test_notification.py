...
from wshop.notify.models.notification import Notification
from wshop.notify.script import Context
from wshop.testing import factories
from wshop_tests.notify.utils import make_bind_data
from wshop_tests.utils import very_recently
...
def test_notification_reverse_url():
    try:
        set_urlconf("wshop_tests.notify.notification_test_urls")
