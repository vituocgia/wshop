...
from wshop_tests.notify.fixtures import ATestEvent
...
def test_notify_item_admin_form():
    ...
    script_item = SendEmail({
        ...
        "recipient": {"constant": "hello@wshop.local"},
    ...
    form = ScriptItemEditForm(
        ...
        data={
            "b_recipient_c": "konnichiwa@jp.wshop.local",
            "b_language_c": "en",
    ...
    form.save()
    assert script_item.data["recipient"] == {"constant": "konnichiwa@jp.wshop.local"}
