...
from wshop.xtheme.layout import Layout, LayoutCell
from wshop.xtheme.plugins.text import TextPlugin
from wshop.xtheme.rendering import get_view_config, render_placeholder
