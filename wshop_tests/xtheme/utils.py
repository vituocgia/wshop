...
from wshop.xtheme import parsing, Theme
from wshop.xtheme.editing import is_edit_mode, set_edit_mode
from wshop.xtheme.view_config import Layout
...
def plugin_override():
    return override_provides("xtheme_plugin", [
        ...
        "wshop_tests.xtheme.test_resources:ResourceInjectorPlugin"
    ])
