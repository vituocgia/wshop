...
#
# Copyright (c) 2012-2018, Wshop Ltd. All rights reserved.
#
...
from wshop.front.apps.carousel.models import Carousel, LinkTargetType, Slide
from wshop.front.apps.carousel.plugins import BannerBoxPlugin, CarouselPlugin
