...
from wshop.core.models import ShopProductVisibility, ProductVisibility
from wshop.front.apps.simple_search.forms import get_search_product_ids
from wshop.front.apps.simple_search.views import SearchView
