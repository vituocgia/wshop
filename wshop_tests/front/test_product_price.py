...
from wshop.front.themes.views._product_price import ProductPriceView
from wshop.testing.factories import create_product, get_default_product, get_default_shop, get_default_supplier
...
def test_product_price(client):
    ...
    response = client.get(
        reverse('wshop:xtheme_extra_view', kwargs={
                'view': 'product_price'
            }
