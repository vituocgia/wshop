...
from wshop.core.models import Order, PaymentStatus, Product
...
from wshop.testing.models import (
...
def _populate_client_basket(client):
    ...
    for i in range(3): # add three different products
        ...
        basket_path = reverse("wshop:basket")
