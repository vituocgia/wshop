...
from wshop.core.models import SavedAddress
from wshop.core.models import get_person_contact
from wshop.core.models._contacts import get_company_contact
from wshop.testing.factories import get_default_shop, get_address
from wshop_tests.utils import SmartClient
from wshop_tests.utils.fixtures import regular_user, REGULAR_USER_PASSWORD, REGULAR_USER_USERNAME
...
def test_addressbook_no_address(regular_user):
    ...
    addressbook_url = reverse("wshop:address_book")
...
def test_addressbook_addresses_create_and_edit(regular_user):
    ...
    new_address_url = reverse("wshop:address_book_new")
    ...
    edit_url = reverse("wshop:address_book_edit", kwargs={"pk": sa.pk})
...
def delete_address(regular_user):
    ...
    delete_url = reverse("wshop:address_book_delete", kwargs={"pk":sa.pk})
