...
from wshop.core.models import AnonymousContact
from wshop.core.pricing import get_pricing_module
from wshop.customer_group_pricing.models import CgpDiscount, CgpPrice
from wshop.customer_group_pricing.module import CustomerGroupPricingModule
...
pytestmark = pytest.mark.skipif("wshop.customer_group_pricing" not in settings.INSTALLED_APPS,
                                reason="customer_group_pricing not installed")

original_pricing_module = settings.WSHOP_PRICING_MODULE


def setup_module(module):
    settings.WSHOP_PRICING_MODULE = "customer_group_pricing"


def teardown_module(module):
    settings.WSHOP_PRICING_MODULE = original_pricing_module
