...
from wshop.admin.modules.products.views.edit import ProductEditView
from wshop.core import cache
from wshop.core.models import StockBehavior
from wshop.simple_supplier.admin_module.forms import SimpleSupplierForm
from wshop.simple_supplier.admin_module.views import (
    process_alert_limit, process_stock_adjustment
)
from wshop.simple_supplier.models import StockAdjustment, StockCount
...
def test_supplier_with_stock_counts_2(rf, admin_user, settings):
    with override_settings(WSHOP_HOME_CURRENCY="USD", WSHOP_ENABLE_MULTIPLE_SHOPS=False):
        supplier = get_simple_supplier()
        shop = get_default_shop()
