...
from wshop.core.models import ShopProductVisibility
...
@pytest.mark.parametrize("class_spec", [
    "wshop.admin.modules.categories.views.list:CategoryListView",
    "wshop.admin.modules.contacts.views:ContactListView",
    "wshop.admin.modules.orders.views:OrderListView",
    "wshop.admin.modules.products.views:ProductListView",
])
...
@pytest.mark.parametrize("model_and_class", [
    (get_default_category, "wshop.admin.modules.categories.views:CategoryEditView"),
    (create_random_person, "wshop.admin.modules.contacts.views:ContactDetailView"),
    (random_order, "wshop.admin.modules.orders.views:OrderDetailView"),
    (get_default_product, "wshop.admin.modules.products.views:ProductEditView"),
])
@pytest.mark.django_db
...
def test_product_edit_view(rf, admin_user, settings):
    ...
    if settings.WSHOP_AUTO_SHOP_PRODUCT_CATEGORIES:
