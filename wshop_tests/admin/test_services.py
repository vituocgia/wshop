...
from wshop.admin.modules.services.base_form_part import ServiceBaseFormPart
from wshop.admin.modules.services.forms import PaymentMethodForm, ShippingMethodForm
from wshop.admin.modules.services.views import (
