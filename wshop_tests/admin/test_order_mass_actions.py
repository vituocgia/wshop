...
import pytest
from wshop.admin.modules.orders.mass_actions import CancelOrderAction, OrderDeliveryPdfAction, \
    OrderConfirmationPdfAction
from wshop.admin.modules.orders.views import OrderListView
from wshop.core.models import Order
from wshop.core.models import OrderStatusRole
from wshop.testing.factories import get_default_supplier, get_default_shop, create_random_order, create_product, \
