...
from wshop.admin.modules.sample_data import manager
from wshop.admin.modules.sample_data.data import BUSINESS_SEGMENTS
from wshop.admin.modules.sample_data.forms import ConsolidateObjectsForm
from wshop.admin.modules.sample_data.views import ConsolidateSampleObjectsView
from wshop.admin.views.dashboard import DashboardView
from wshop.admin.views.wizard import WizardView
from wshop.core.models import AnonymousContact, Category, Product, Shop
from wshop.front.apps.carousel.models import Carousel, Slide
