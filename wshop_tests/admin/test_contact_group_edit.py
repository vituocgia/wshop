...
from wshop.admin.modules.contact_groups.views import ContactGroupEditView
from wshop.admin.modules.contact_groups.views.forms import (
...
def check_for_delete(request, contact_group, can_delete):
    delete_url = reverse("wshop_admin:contact_group.delete", kwargs={"pk": contact_group.pk})
