...
from wshop.admin.modules.products.views import (
    ProductEditView, ProductMediaBulkAdderView
)
from wshop.admin.modules.services import (
...
from wshop.core.models import ProductMedia, ProductMediaKind, ProductVisibility
