...
from wshop.admin.utils.picotable import PicotableMassAction, PicotableFileMassAction
from wshop.core.models import Product
from wshop.testing.factories import get_default_shop, get_default_supplier, create_product
