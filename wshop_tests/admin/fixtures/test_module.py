...
class ATestModule(AdminModule):
    ...
    def get_urls(self):
        return [
            ...
            admin_url(
                "test2/$", "wshop_tests.admin.fixtures.test_module.OkAction",
                name="test-unauth", require_authentication=False),
            admin_url(
                "test3/$", "wshop_tests.admin.fixtures.test_module.OkAction",
...
class ARestrictedTestModule(ATestModule):
    ...
    def get_required_permissions(self):
        return set(["wshop.add_product", "wshop.delete_product", "wshop.change_product"])
