...
from wshop.admin.modules.users.views import (
    LoginAsUserView, UserChangePermissionsView, UserDetailView
)
from wshop.admin.modules.users.views.permissions import (
    PermissionChangeFormBase
)
from wshop.core.models import Contact, get_person_contact
