...
from wshop.admin.modules.shops.views.edit import ShopBaseForm
from wshop.core.models import ConfigurationItem, Shop, ShopStatus
from wshop.testing.factories import (
    create_product, create_random_order, create_random_person, get_currency,
    get_default_shop, get_default_supplier
)
from wshop_tests.utils import printable_gibberish, SmartClient
...
def test_order_configuration(rf, admin_user):
    ...
    assert length_field["value"] == str(settings.WSHOP_REFERENCE_NUMBER_LENGTH)  # default value because nothing set yet
