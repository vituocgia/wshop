...
from wshop.admin.dashboard import DashboardContentBlock, get_activity
from wshop.admin.menu import get_menu_entry_categories
from wshop.admin.module_registry import (
...
from wshop_tests.admin.fixtures.test_module import ATestModule, ARestrictedTestModule
from wshop_tests.utils import empty_iterable
from wshop_tests.utils.faux_users import (
    AnonymousUser, AuthenticatedUser, StaffUser, SuperUser
)
from wshop_tests.utils.templates import \
...
def test_module_loading_and_urls():
    with replace_modules([
        ATestModule,
        "wshop_tests.admin.fixtures.test_module:ATestModule"
    ]):
