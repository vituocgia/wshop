...
from wshop.admin.modules.service_providers.views import ServiceProviderEditView
...
from wshop.testing.models import PseudoPaymentProcessor
from wshop.testing.utils import apply_all_middleware
...
@pytest.mark.parametrize("sp_model,type_param", [
    (None, None),
    (CustomCarrier, "wshop.customcarrier"),
    (CustomPaymentProcessor, "wshop.custompaymentprocessor")
])
    ...
    with override_settings(LANGUAGES=[("en", "en")]):
        ...
        if type_param:
            ...
            assert selected_type in [
                "wshop.customcarrier", "wshop.custompaymentprocessor",
                "wshop_testing.pseudopaymentprocessor"
            ]
        ...
        if sp_model:
            ...
            if selected_type == "wshop.custompaymentprocessor":
...
@pytest.mark.parametrize("type,extra_inputs", [
    ("wshop.custompaymentprocessor", ["rounding_quantize"]),
    ("wshop_testing.pseudopaymentprocessor", ["bg_color", "fg_color"])
])
