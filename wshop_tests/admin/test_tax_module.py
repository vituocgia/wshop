...
from wshop.admin.modules.taxes import TaxModule
from wshop.admin.modules.taxes.views import TaxClassEditView
from wshop.testing.factories import get_default_shop, get_default_tax_class
