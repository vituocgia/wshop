...
from wshop.admin.menu import get_menu_entry_categories
from wshop.admin.modules.customers_dashboard import CustomersDashboardModule
from wshop.admin.modules.sales_dashboard import SalesDashboardModule
from wshop.admin.module_registry import get_modules, replace_modules
...
from wshop_tests.admin.fixtures.test_module import ARestrictedTestModule
from wshop_tests.utils.faux_users import StaffUser


migrated_permissions = {
    CustomersDashboardModule: ("wshop.view_customers_dashboard"),
    SalesDashboardModule: ("wshop.view_sales_dashboard"),
}
