...
import wshop_setup_utils as utils

TOPDIR = os.path.abspath(os.path.dirname(__file__))
LONG_DESCRIPTION_FILE = os.path.join(TOPDIR, 'README.rst')
VERSION_FILE = os.path.join(TOPDIR, 'wshop', '_version.py')
...
#        git tag -a -m "Wshop X.Y.Z" vX.Y.Z
...
AUTHOR_EMAIL = 'wshop@wshop.com'
URL = 'http://wshop.com/'
DOWNLOAD_URL_TEMPLATE = (
    'https://github.com/wshop/wshop/releases/download/'
    'v{version}/wshop-{version}-py2.py3-none-any.whl')
