...
Data in Wshop is stored into database using regular :mod:`Django models
<django.db.models>` and it is accessed with Django's normal :ref:`query
API <retrieving-objects>`.  See :mod:`wshop.core.models` for list of
models in :term:`Wshop Core`.
...
Basic models (like :class:`~wshop.core.models.Product`,
:class:`~wshop.core.models.Category` or
:class:`~wshop.core.models.Order`) cannot be replaced.  To extend them,
...
.. code-block:: python
   ...
   from wshop.core import models as wshop_models

   class MyProduct(models.Model):
       product = models.OneToOneField(wshop_models.Product)
...
Polymorphic models (like :class:`~wshop.core.models.Contact`) can be
...
:class:`Contacts <wshop.core.models.Contact>` with a query like
...
:class:`~wshop.core.models.CompanyContact` and your custom class.
