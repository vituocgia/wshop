...
"""
Wshop documentation build configuration file
"""
...
def initialize_django():
    os.environ['DJANGO_SETTINGS_MODULE'] = 'wshop_workbench.settings'
...
def patch_for_introspection():
    import wshop_introspection_helper
    wshop_introspection_helper.enable_patches()
...
latex_documents = [
  ('index', 'Wshop.tex', 'Wshop Documentation',
...
man_pages = [
    ('index', 'wshop', 'Wshop Documentation',
...
texinfo_documents = [
  ('index', 'Wshop', 'Wshop Documentation',
   'Shoop Commerce Ltd.', 'Wshop', 'One line description of project.',
   'Miscellaneous'),
]
