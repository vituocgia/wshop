...
.. code-block::  shell
   ...
   python _misc/doccov.py -o report.html wshop
...
.. code-block::  shell
   ...
   python _misc/ensure_code_style.py wshop
...
.. code-block::  shell
   ...
   python _misc/ensure_license_headers.py wshop
   # or to write changes:
   python _misc/ensure_license_headers.py -w wshop
...
.. code-block::  shell
   ...
   python _misc/ensure_unicode_literals.py wshop
   # or to write changes:
   python _misc/ensure_unicode_literals.py -w wshop
