...
When Wshop determines if a product should have a
discounted price, it looks for the
`DiscountModules <wshop.core.pricing.DiscountModule>` in the system.
...
.. code-block:: python
    ...
    from wshop.campaigns.models import ContextCondition
...
.. code-block:: python
    ...
    from wshop.campaigns.admin_module.forms._base.BaseRuleModelForm
...
doesn't already exist. Like many things in Wshop, functionality can be
