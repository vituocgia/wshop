...
As an open source platform under active development, Wshop gladly
welcomes all contributions and feedback. As soon as you
learn `Wshop basics <http://wshop.readthedocs.io/en/latest/>`_,
you can contribute in several ways:

* Join our `community forums <https://community.wshop.com/forums/>`_
  and `gitter group <https://gitter.im/wshop/wshop>`_ to help answer questions.
* Report issues on our `issue tracker <https://wshopteam.atlassian.net/issues>`_.
* Submit pull requests for new or corrected behavior.
* Improve the `developer documentation <http://wshop.readthedocs.io/en/latest/>`_.
* Improve the `merchant documentation <http://wshop-guide.readthedocs.io/en/latest/>`_.
* Write unit tests.
...
of Wshop and search the forums and issue tracker to see if the issue has
...
* Fork our `Github repository <https://github.com/wshop/wshop>`_ and create your branch from master.
...
As a project built on Django, Wshop adheres to the
...
Want to learn more about Wshop internals? Adding unit tests that increase
